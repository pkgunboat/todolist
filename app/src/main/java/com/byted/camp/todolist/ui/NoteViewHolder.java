...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        if(note.getState() == note.getState().TODO) {
            switch (note.getPriority()) {
                case 1: itemView.setBackgroundColor(Color.WHITE); break;//白色
                case 2: itemView.setBackgroundColor(Color.BLUE); break;//蓝色
                case 3: itemView.setBackgroundColor(Color.YELLOW); break;//黄色
                case 4: itemView.setBackgroundColor(Color.RED); break;//红色
            }
        } else {
